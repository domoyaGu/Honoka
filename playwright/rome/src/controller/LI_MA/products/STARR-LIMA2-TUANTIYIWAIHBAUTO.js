    ...
    return new Promise(async (resolve, reject) => {
      ...
      for (let key in occupMap) {
        ...
        if (position.length < 3) {
          ...
          await page.locator('#positionLevel1').selectOption(position[2].substring(0,2));
          await page.locator('#positionLevel2').selectOption(position[2].substring(0,4));
