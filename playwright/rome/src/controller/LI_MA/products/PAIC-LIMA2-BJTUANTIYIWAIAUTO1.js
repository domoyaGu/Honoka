...
class OrderController {
  ...
  async order(reqBody) {
    return new Promise(async (resolve, reject) => {
      logger.info('BJ-平安团意险(网)ABC自选套餐')
        ...
        switch(t.typeStr) {
          ...
          case '意外身故/残疾':
            await page.getByRole('combobox').first().selectOption({
              '10万': '1', '20万': '2', '30万': '3', '40万': '4', '50万': '5', '60万': '6', '70万': '7', '80万': '8',
              '90万': '9', '100万': '10', '110万': '11', '120万': '12',
            }[t.optionName]);
            break;
          case '意外医疗':
            ...
            break;
          // case '猝死':
          //   await page.getByRole('combobox').nth(3).selectOption({
          //     '不投保': '0', '5万': '1', '10万': '2'
          //   });
          //   break;
          case '意外住院津贴':
