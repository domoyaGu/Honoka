    ...
    return new Promise(async (resolve, reject) => {
      ...
      try {
        ...
        if (pageData) {
          ...
          logger.info('平安团体意外险方案(JS)(互联网)工标10')
          // 认证信息
          ...
          switch(reqBody.orderGroupBean.invoiceType) {
            ...
            case '2':
              ...
              if (contactAddressArr.length === 3) {
                ...
                // 市辖区中文不同
                let address2 = ['北京市', '重庆市', '上海市'].includes(contactAddressArr[0]) ? contactAddressArr[0]+contactAddressArr[1] : contactAddressArr[1]
                await page.locator('select[name="contact_address_city"]').selectOption(address2);
