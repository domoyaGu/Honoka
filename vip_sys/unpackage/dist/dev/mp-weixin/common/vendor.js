...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"vip_shop_02","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 33 */
/*!******************************************!*\
  !*** E:/0honoka/vip_sys/common/share.js ***!
  \******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 48 */
/*!*******************************************!*\
  !*** E:/0honoka/vip_sys/common/ar-aes.js ***!
  \*******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 49 */
/*!******************************************!*\
  !*** E:/0honoka/vip_sys/common/Units.js ***!
  \******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

/* WEBPACK VAR INJECTION */(function(uni) {function getTime() {
  var date = new Date();
...
function timeAddDay(timeString, num) {
  var stemp = timeTostemp(timeString);
  stemp = stemp + 1000 * 60 * 60 * 24 * num;
  var time = stempTotime(stemp);
  return time;
}
;
...
function getNorepeatArray(start, end) {
  ...
  var res = [];
  for (var i = 0; i < n; i++) {
    var index = parseInt(Math.random() * a.length); //生成一个的随机索引，索引值的范围随数组a的长度而变化
    res.push(a[index]);
...
function getViewinfo(viewID) {
  ...
  uni.getSystemInfo({
    success: function success(res) {
      var info = uni.createSelectorQuery().select("#" + viewID);
...
function getHexColor(rgbColor) {
  var values = [rgbColor.R, rgbColor.G, rgbColor.B, rgbColor.A];
  ...
  // 转换后的16进制可能为一位，比如 7 就转换为 7 ， 15 转换为 f
...
function getPagePath() {
  ...
  var currentPage = pages[pages.length - 1]['$page']['fullPath'];
  return currentPage;
}
;
...
module.exports = {
  ...
  getNorepeatArray: getNorepeatArray,
  getViewinfo: getViewinfo,
  getHexColor: getHexColor,
  getCanvarRgba: getCanvarRgba,
  randomNum: randomNum,
  andriodtimeTostemp: andriodtimeTostemp,
  iostimeTostemp: iostimeTostemp,
  stempTotime: stempTotime,
